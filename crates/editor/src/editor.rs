...
impl Editor {
    ...
    pub fn mark_inlay_hint_resolved(&mut self, inlay_id: InlayId, cx: &mut Context<Self>) {
        eprintln!("Marking inlay hint as resolved: {:?}", inlay_id);
        self.resolved_inlay_hints_pending_hover.insert(inlay_id);
        cx.notify();
    }
